...
public class MultipleConflictsManagementTestFX extends ApplicationTest {
    ...
    public void testResolveMultipleConflicts() throws Exception{
        ...
        ConflictManagementToolController conflictManagementToolController
                = sessionController.getConflictManagementToolController();
        System.out.println("Pointer is " + conflictManagementToolController);
        clickOn("#rightAccept");
        ...
        WaitForAsyncUtils.waitFor(timeoutDelay, TimeUnit.SECONDS,
                                  () -> !conflictManagementToolController.getGuiWaiting());
