...
public class SshPrivateKeyPasswordInitRepoFXTest extends ApplicationTest {
    ...
    public void start(Stage stage) throws Exception {
        ...
        String pathString = helper.getLocalPath().toString();
        PrefObj.putObject(prefs, LAST_OPENED_REPO_PATH_KEY, pathString);
    ...
    public void testSshPrivateKey() throws Exception {
        console.info("Running test " + Thread.currentThread());
