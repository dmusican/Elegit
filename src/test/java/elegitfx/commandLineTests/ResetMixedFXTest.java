 ...
 * Tests reset mixed by clicking on a commit in the tree
 */
public class ResetMixedFXTest extends ApplicationTest {
    @Rule
    ...
    @Test
    public void resetMixedTest() throws Exception {
        ...
        final String[] mixedId = commandLineTestUtilities.clickReset(prevCommit, "mixed");
        commandLineTestUtilities.checkCommandLineText("git reset --mixed " + mixedId[0]);
    }
}
