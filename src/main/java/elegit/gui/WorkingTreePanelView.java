...
//    }
     ...
     */
    @Override
    protected void addTreeItemsToRoot(List<RepoFile> updatedRepoFiles) {
        Main.assertFxThread();

        CheckBoxTreeItem<String> gilesFamily = new CheckBoxTreeItem<String>("Giles Family");
//        gilesFamily.setExpanded(true);
        directoryTreeView.setRoot(gilesFamily);
        directoryTreeView.setCellFactory(CheckBoxTreeCell.<String>forTreeView());
